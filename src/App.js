...
<div className="flex flex-col md:flex-row gap-4">
  ...
  <button className="px-6 py-2 bg-red-500 hover:bg-red-600 rounded-lg text-lg shadow-lg">
    Decrement
  </button>
  <button className="px-6 py-2 bg-yellow-500 hover:bg-yellow-600 rounded-lg text-lg shadow-lg">
    Reset
  </button>
</div>
